...
class ModelTrainer:
    ...
    def train_model(self,x_train,y_train,x_test,y_test):
        ...
        Network_Security_model=NetworkSecurityModel(preprocessor=preprocessor,model=best_model)
        save_object(self.model_trainer_config.trained_model_file_path,obj=Network_Security_model)
