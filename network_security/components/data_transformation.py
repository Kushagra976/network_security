...
class DataTransformation:
    ...
    def get_data_transformer_object(self)->Pipeline:
        '''
        initialises a KNN imputer object with parameters specified in training pipeline.py
        '''
        logging.info("entered the get_data_transformer_object method of DataTransformation class")
        try:
            imputer:KNNImputer=KNNImputer(**DATA_TRANSFORMATION_IMPUTER_PARAMS)
            logging.info(f"initiated a knn imputer object with {DATA_TRANSFORMATION_IMPUTER_PARAMS}")
